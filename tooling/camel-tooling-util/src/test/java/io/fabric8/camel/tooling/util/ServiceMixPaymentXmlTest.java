...
public class ServiceMixPaymentXmlTest extends RouteXmlTestSupport {

    @Test
    public void testParsesValidXmlFile() throws Exception {
        XmlModel x = assertRoutes(new File(getBaseDir(), "src/test/resources/servicemix4-payment-router.xml"), 2, null);
