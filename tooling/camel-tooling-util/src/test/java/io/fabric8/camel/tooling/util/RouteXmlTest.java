...
public class RouteXmlTest extends RouteXmlTestSupport {

    @Test
    public void testParsesEmptyXmlFile() throws Exception {
        assertRoutes(new File(getBaseDir(), "src/main/resources/io/fabric8/camel/tooling/exemplar.xml"), 0, null);
    }

    @Test
    public void testParsesValidXmlFile() throws Exception {
        XmlModel x = assertRoutes(new File(getBaseDir(), "src/test/resources/simpleRoute.xml"), 1, null);
