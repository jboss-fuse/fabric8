...
public class Status extends AbstractCommandComponent {
    ...
    public static final String DESCRIPTION = "Displays the current status of the fabric by comparing the requirements to the actual instance counts";
    ...
    public Action createNewAction() {
        assertValid();
        return new StatusAction(fabricService.get());
    }
