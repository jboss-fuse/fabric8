...
@org.apache.felix.scr.annotations.Properties({
    @Property(name = "osgi.command.scope", value = RequirementsExport.SCOPE_VALUE),
    @Property(name = "osgi.command.function", value = RequirementsExport.FUNCTION_VALUE)
})
public class RequirementsExport extends AbstractCommandComponent {

    public static final String SCOPE_VALUE = "fabric";
    public static final String FUNCTION_VALUE = "requirements-export";
    public static final String DESCRIPTION = "Exports the current requirements metadata to a JSON file";
    ...
    public Action createNewAction() {
        assertValid();
        return new RequirementsExportAction(fabricService.get());
    }
