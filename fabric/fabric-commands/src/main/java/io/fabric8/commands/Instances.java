...
@Command(name = Instances.FUNCTION_VALUE, scope = Instances.SCOPE_VALUE, description = CreateCommand.DESCRIPTION)
@Component(immediate = true)
@Service({ Function.class, AbstractCommand.class, JoinAvailable.class })
@org.apache.felix.scr.annotations.Properties({
        @Property(name = "osgi.command.scope", value = Instances.SCOPE_VALUE),
        @Property(name = "osgi.command.function", value = Instances.FUNCTION_VALUE)
})
public class Instances extends AbstractCommandComponent implements JoinAvailable {
    ...
    public Action createNewAction() {
        assertValid();
        return new InstancesAction(runtimeProperties.get(), fabricService.get(), curator.get());
    }
    ...
    void bindContainerCompleter(ContainerCompleter completer) {
        bindOptionalCompleter("--container", completer);
    }

    void unbindContainerCompleter(ContainerCompleter completer) {
        unbindOptionalCompleter("--container");
    }
