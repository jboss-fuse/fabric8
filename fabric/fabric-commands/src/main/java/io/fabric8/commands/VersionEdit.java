...
@org.apache.felix.scr.annotations.Properties({
    @Property(name = "osgi.command.scope", value = VersionEdit.SCOPE_VALUE),
    @Property(name = "osgi.command.function", value = VersionEdit.FUNCTION_VALUE)
})
public class VersionEdit extends AbstractCommandComponent {

    public static final String SCOPE_VALUE = "fabric";
    public static final String FUNCTION_VALUE = "version-edit";
    public static final String DESCRIPTION = "Edit version description";
    ...
    public Action createNewAction() {
        assertValid();
        return new VersionEditAction(fabricService.get());
    }
