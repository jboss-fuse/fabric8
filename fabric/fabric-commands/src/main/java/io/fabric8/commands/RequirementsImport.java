...
@org.apache.felix.scr.annotations.Properties({
    @Property(name = "osgi.command.scope", value = RequirementsImport.SCOPE_VALUE),
    @Property(name = "osgi.command.function", value = RequirementsImport.FUNCTION_VALUE)
})
public class RequirementsImport extends AbstractCommandComponent {

    public static final String SCOPE_VALUE = "fabric";
    public static final String FUNCTION_VALUE = "requirements-import";
    public static final String DESCRIPTION = "Imports the profile scaling requirements from a JSON configuration file";
    ...
    public Action createNewAction() {
        assertValid();
        return new RequirementsImportAction(fabricService.get());
    }
